 ...
 * <p>
 * В данном примере используется кэш, реализованный с помощью библиотеки Caffeine.
 * Кэш имеет ограничение на количество записей и время жизни каждой записи.
 * Если данные уже находятся в кэше, они возвращаются из кэша. В противном случае,
 * данные загружаются из базы данных (или эмулируются) и сохраняются в кэш для последующего использования.
 * </p>
 */
